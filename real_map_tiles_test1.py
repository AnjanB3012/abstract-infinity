...
'''
    ...
    print("----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------")
    print("The time it took for the algorithm with float('inf') to compute the route from "+key+" is "+str(timeit.timeit(stmt=Map_test_basic,setup=setup_code, number=1)))
    print("The time it took for the algorithm with AbsInf to compute the route from "+key+" is "+str(timeit.timeit(stmt=Map_test_abs,setup=setup_code, number=1)))
    print("----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------")